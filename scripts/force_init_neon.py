#!/usr/bin/env python3
"""
Force initialize Neon database - drop alembic_version and create all tables fresh.
"""
...
def force_init():
    ...
    print("=" * 60)
    print("VIJETHA DIGITAL - Force Initialize Neon Database")
    print("=" * 60)
    print()
    ...
    try:
        ...
        print()
        print("Next steps:")
        print("1. Run: seed_neon_database.bat")
        print("   OR: py scripts\\seed_products.py")
        print("2. Test backend: https://vijetha-digital-backend.onrender.com/products")
        print()
