...
export default function StaffForgotPassword() {
  ...
  return (
    <AuthLayout
      ...
      leftSubtitle="Recover your staff account and return to your assigned workspace quickly."
    >
      <div className="w-full max-w-md">
        ...
        <header className="mb-8">
          ...
          <p className="text-text-muted">Enter your staff email to receive your secure reset link.</p>
        </header>
